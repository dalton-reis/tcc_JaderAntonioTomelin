...
import { TouchBrailleTesterPage } from '../pages/touch-braille-tester/touch-braille-tester';
...
export class ConferenceApp {
  ...
  PaginasMenu: PageInterface[] = [
    ...
    { title: 'Touch Braille Tester', name: 'TabsPage', component: TouchBrailleTesterPage, icon: 'create' },
